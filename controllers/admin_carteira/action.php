        ...
        case 'carteira' :
            ...
            foreach ($_REQUEST['atletas'] as $key => $value) {
                ...
                if (strlen($strnomeFrente) > 20) {
                    ...
                    $canvas -> writeText('80', '350', 'Registro NК:' . $atleta -> getId(), 0);
                } else {
                    $canvas -> writeText('80', '270', $atleta -> pessoa -> getNomeCompleto(), 0);
                    $canvas -> writeText('80', '270', 'Registro NК:' . $atleta -> getId(), 0);
                }
                ...
                $canvas -> writeText('40', '32', "Associaчуo", 0);
                $canvas -> writeText('40', '104', "Nome", 0);
                $canvas -> writeText('40', '178', "Graduaчуo", 0);
