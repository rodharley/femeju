...
$TPL->BREADCRUMB = '<section class="content-header">
                   ...
                   <ol class="breadcrumb">
                                        ...
                                        <li><a href="admin_anuidade-main"><i class="fa fa-trophy"> </i> Relatórios</a></li>
                                         <li class="active">Exportar Fushikai</li>
                                    </ol>
                </section>';


$TPL->addFile("CONTEUDO", "templates/admin/relatorios/comp_exportar.html");
$rs = $ocomp->listaTodas();
...
$rs = $oass->listaAtivas("nome");
foreach ($rs as $key => $value) {
	$TPL->TITULO_ASS = $value->nome;
	$TPL->ID_ASS = $value->id;
