...
$idComp = $objPag->md5_decrypt($_REQUEST['idComp']);
$rs = $objInscr->getInscricoes($idComp,$objPag->id);
...
foreach ($rs as $key => $inscricao) {
	...
	$TPL->DESCRICAO_DOBRA2 = $inscricao->dobra1 != null ? $inscricao->dobra2->descricao : "Não Selecionada";
	$TPL->VALOR_DOBRA2 = $objPag->money($inscricao->valorDobra2,"atb");
	$TPL->disabled2 = $inscricao->dobra2 == null ? "disabled" : "";
	$TPL->DESCRICAO_DOBRA3 = $inscricao->dobra1 != null ? $inscricao->dobra3->descricao : "Não Selecionada";
