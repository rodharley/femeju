...
class Template {
	...
	/**
	 * Não use este mãtodo, ele serve apenas para podemos acessar as variãveis 
	 * de template diretamente.
	 *
	 * @param	string	$varname	template var name
	 */
	...
	/**
	 * Verifica se uma variãvel de template existe.
	 *
	 * Retorna true se a variãvel existe. Caso contrãrio, retorna false.
	 *
	 * @param	string	$varname	template var name
	 */
	...
	/**
	 * Limpa o valor de uma variãvel
	 * 
 	 * O mesmo que $this->setValue($varname, "");
	 *
	 * @param     string $varname	nome da variãvel
	 */
